...
@Composable
fun WalletTransactionsScreen(navController: NavController, viewModel: AssetTransactionsViewModel = hiltViewModel()){
            ...
            if (transactionList.isEmpty()){
                ...
                items(
                    ...
                    AssetTransactionItem(
                        item = tradeItem,
                        onClick = {tradeId ->
                            navController.navigate("walletTransactionDetailScreen/$tradeId")
                        }
                    )
